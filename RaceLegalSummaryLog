...
local function myexit()
	if(Exited) then
		...
		file = io.open(s, "a")
		local timet,temp1,index=0,0,0
		io.output(file)
		io.write("{\n")
		timet=FormatTop(Overworld)
		temp1=FormatTop(Underground)
		timet=timet+temp1
		temp1=FormatTop(Dungeons)
		timet=timet+temp1
		temp1=FormatTop(MoonArea)
		timet=timet+temp1
		io.write(string.format("\"Zeromus\": "))
		temp1=FormatBottom(Zeromus)
		timet=timet+temp1
		io.write(string.format(",\n\"Misc\": "))
		temp1=FormatBottom(Misc)
		timet=timet+temp1
